...
/**
 * @ORM\Entity(repositoryClass="App\Repository\BlessuresRepository")
 */
class Blessures
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Personnages", mappedBy="blessures", orphanRemoval=true)
     */
    ...
    public function addIdPersonnage(Personnages $idPersonnage): self
    {
        if (!$this->idPersonnage->contains($idPersonnage)) {
            ...
            $idPersonnage->setBlessures($this);
        }
    ...
    public function removeIdPersonnage(Personnages $idPersonnage): self
    {
        if ($this->idPersonnage->contains($idPersonnage)) {
            ...
            if ($idPersonnage->getBlessures() === $this) {
                $idPersonnage->setBlessures(null);
            }
        }

...
class Sorts
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Personnages", mappedBy="sorts", orphanRemoval=true)
     */
    ...
    public function removeIdPersonnage(Personnages $idPersonnage): self
    {
        if ($this->idPersonnage->contains($idPersonnage)) {
            ...
            if ($idPersonnage->getSorts() === $this) {
                $idPersonnage->setSorts(null);
            }
        }

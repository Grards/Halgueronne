...
class Competences
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Personnages", mappedBy="competences", orphanRemoval=true)
     */
    ...
    public function addIdPersonnage(Personnages $idPersonnage): self
    {
        if (!$this->idPersonnage->contains($idPersonnage)) {
            ...
            $idPersonnage->setCompetences($this);
        }
    ...
    public function removeIdPersonnage(Personnages $idPersonnage): self
    {
        if ($this->idPersonnage->contains($idPersonnage)) {
            ...
            if ($idPersonnage->getCompetences() === $this) {
                $idPersonnage->setCompetences(null);
            }
        }

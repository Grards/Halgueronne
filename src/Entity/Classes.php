...
class Classes
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Personnages", mappedBy="classes", orphanRemoval=true)
     */
    ...
    public function removeIdPersonnage(Personnages $idPersonnage): self
    {
        if ($this->idPersonnage->contains($idPersonnage)) {
            ...
            if ($idPersonnage->getClasses() === $this) {
                $idPersonnage->setClasses(null);
            }
        }
